...
var SAMPLE_PATH = path.join(__dirname, '../server/main.js');
...
describe('appengine/meteor/server/main.js', function () {
  var sample;
  ...
  it('should render index page', function (done) {
    var expectedResult = 'Hello World, from Meteor and Google App Engine.';
